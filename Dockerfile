...
RUN curl -sL "https://releases.hashicorp.com/terraform/0.11.3/terraform_0.11.3_linux_amd64.zip"> terraform.zip \
  && unzip terraform.zip \
  && mv terraform /usr/local/bin

RUN curl -sL "https://releases.hashicorp.com/packer/1.2.0/packer_1.2.0_linux_amd64.zip" > packer.zip \
  && unzip packer.zip \
